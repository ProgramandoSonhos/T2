    ...
    <section id="exemplo">
        ...
        <fieldset>
          ...
          <p>
            ...
            <input name="nome" type="text" id="nome" size="50" maxlength="50" required value="<?php echo $nome ?>">
          ...
          <p>
            ...
            <input name="cpf" type="text" id="cpf" size="16" maxlength="14" required value="<?php echo $cpf ?>">
          </p>
          <p>
